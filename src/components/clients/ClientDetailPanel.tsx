              ...
              <div className="space-y-2">
                {client.primary_phone && (
                  <div className="flex items-center gap-2.5 p-2.5 rounded-xl bg-blue-50 border border-blue-100 hover:border-blue-300 text-sm text-[#191B23] transition-all group">
                    ...
                    <a href={`tel:${client.primary_phone}`} className="flex-1 font-medium hover:underline hover:text-[#1A56DB]">{client.primary_phone}</a>
                    <WaBadge phone={client.primary_phone} />
                    <a href={`https://wa.me/${client.primary_phone.replace(/\D/g, '')}`} target="_blank" rel="noopener noreferrer" className="text-[#25D366] hover:text-[#128C7E] shrink-0" title="WhatsApp">
