...
- **Calendar alert badges:** day cells show pulsing dot — red = confirmed with no driver, amber = draft/pending. Cards show `⚠ No Driver Assigned` / `⚠ Draft — Confirm` action tags with bold left border.
